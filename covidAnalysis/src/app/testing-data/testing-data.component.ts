...
export class TestingDataComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.http.get('http://127.0.0.1:5000/api/byLargestTestingIncrease').subscribe(data => {
      this.testing_data = data;
      this.createGraph(data);
    });
  }

  createGraph(data) {
    const chart = am4core.create('testRecords', am4charts.XYChart);
    chart.data = data;
    ...
    series.dataFields.valueY = 'maxTestIncrease';
